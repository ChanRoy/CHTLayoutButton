...
- (void)viewDidLoad {
    ...
    CHTLayoutButton *leftBtn = [[CHTLayoutButton alloc]initWithFrame:CGRectMake(0, 0, 90, 90) subMargin:2 layoutButtonType:CHTLayoutButtonTypeLeft];
    ...
    CHTLayoutButton *rightBtn = [[CHTLayoutButton alloc]initWithFrame:CGRectMake(0, 0, 90, 90) subMargin:2 layoutButtonType:CHTLayoutButtonTypeRight];
    ...
    CHTLayoutButton *topBtn = [[CHTLayoutButton alloc]initWithFrame:CGRectMake(0, 0, 90, 90) subMargin:2 layoutButtonType:CHTLayoutButtonTypeTop];
    ...
    CHTLayoutButton *bottomBtn = [[CHTLayoutButton alloc]initWithFrame:CGRectMake(0, 0, 90, 90) subMargin:2 layoutButtonType:CHTLayoutButtonTypeBottom];
